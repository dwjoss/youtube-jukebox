...
templates['search-result'] = template({"compiler":[6,">= 2.0.0-beta.1"],"main":function(depth0,helpers,partials,data) {
  ...
  return "// assumes we have access to a YouTube JSON object: search-result\n\n<li class=\"list-group-item\" style=\"padding: 10px\" data-id="
    ...
    + "</h4>   \n    <span class=\"date\">"
    + escapeExpression(lambda(((stack1 = (depth0 != null ? depth0.statistics : depth0)) != null ? stack1.viewCount : stack1), depth0))
    + " + views + utils.parseTime("
